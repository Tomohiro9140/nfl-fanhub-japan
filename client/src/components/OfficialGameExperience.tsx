...
export type TeamSnapshot = {
  nextGame?: { opponentCode: string; homeAway: "home" | "away"; seasonPhase: "preseason" | "regular" | "postseason"; weekLabel: string | null; kickoffAt: Date; venue: string | null; broadcast: string | null; sourceUrl: string; daznUrl: string | null; fetchedAt: Date };
...
export function OfficialGameTicket({ favorite, snapshot, loading, spoilerMode }: { favorite: FavoriteTeam; snapshot?: TeamSnapshot; loading: boolean; spoilerMode: boolean }) {
  ...
  const watchUrl = game?.daznUrl ?? daznGamePassUrl;
