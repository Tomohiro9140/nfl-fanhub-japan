...
describe("official feed mobile content selection", () => {
  beforeEach(() => {
    mockedItems.splice(0, mockedItems.length,
      ...
      { id: 4, category: "news", title: "News fourth hidden", summary: null, sourceUrl: "https://www.buffalobills.com/news/4", sourceName: "BUF Official News", publishedAt: daysAgo(3), fetchedAt: now },
