...
export default function Atlas() {
  ...
  return <main className="relative min-h-[100dvh] w-full overflow-hidden bg-[#f7f5f0]">
    ...
    <iframe title="NFL Player Atlas" src={originalAtlasUrl} loading="eager" onLoad={() => setIsLoaded(true)} className={`block h-[100dvh] w-full border-0 transition-opacity duration-200 ${isLoaded ? "opacity-100" : "opacity-0"}`} />
  </main>;
}
