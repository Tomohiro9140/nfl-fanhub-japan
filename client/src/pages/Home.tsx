...
export default function Home() {
  ...
  const leagueQuery = trpc.leagueDashboard.summary.useQuery(undefined, { enabled: shouldLoadLeagueCalendar, refetchInterval: 60 * 1000, staleTime: 45 * 1000, refetchOnWindowFocus: true, refetchOnReconnect: true, retry: 1 });
